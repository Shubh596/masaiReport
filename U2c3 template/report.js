...
var photo = document.querySelector("#image").value;
...
console.log(photo, name, batch, dsa, skillathon, coding);

var tr = document.createElement("tr");

var td1 = document.createElement("td");
var student_photo=document.createElement("img");
student_photo.setAttribute("src", photo);
td1.append(student_photo);
